  ...
  try {
    ...
    const criteria = [
      ...
      },
      {
        ...
        count: answerUpvotes?.totalQuestions || 0,
      },
      {
...
export async function getUserAnswers(params: GetUserStatsParams) {
  try {
      ...
      .populate([
        {
          path: "question",
          model: Question,
          select: "_id title upvotes createdAt",
        },
        {
          path: "author",
          model: User,
    ...
    const isNextAnswer = totalAnswers > userAnswers.length + skipAmount;
